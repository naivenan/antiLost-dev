...
Page({
  ...
  getData: function () {
    ...
    qqmapsdk = new QQMapWX({
      key: '2EQBZ-3XM36-RUTSG-MIO6B-GXH4E-B3FC5'  // MYKEY:3KEBZ-JPSWK-YBMJ2-APKZH-TRNN3-F5BSB
    });
    //确保人员再次移动进行定位，获取经纬度
    wx.getLocation({
      type: 'gcj02',
  ...
  doNavToLocation: function () {
    ...
    console.log('param: '+param.briefAddr+','+param.destination+','+param.latitude+','+param.longitude);
    wx.navigateTo({
      url: '../location/location?param=' + JSON.stringify(param)
    })
  },
